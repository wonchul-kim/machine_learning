...
if __name__=='__main__':
    cfg = "mlearning/algs/bpr/BPR-main/configs/bpr/hrnet18s_128.py"
    ckpt = "/DeepLearning/__weights/bpr/hrnet18s_128-24055c80.pth"
    img_paths = ['mlearning/algs/bpr/BPR-main/demo/lindau_000000_000019_leftImg8bit.png', ]            # image
    dt_paths = [['mlearning/algs/bpr/BPR-main/demo/lindau_000000_000019_leftImg8bit_15_car.png'], ]    # coarse mask images: 0 for background, >0 for instance
    inference(cfg, ckpt, img_paths, dt_paths, "/HDD/etc/etc", max_ins=32)
