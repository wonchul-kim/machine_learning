...
if __name__ == '__main__':
    # fire.Fire(main)
    output_dir = '/HDD/etc/inverseForm'
    model_path = '/HDD/weights/inverseForm/hr16s_4k_slim.pth'

    
    main(output_dir=output_dir, model_path=model_path, 
         has_edge=False, model_summary=False, arch='ocrnet.AuxHRNet', 
         hrnet_base=18, num_workers=4, split='val', batch_size=2, crop_size='1024,2048', 
         apex=False, syncbn=False, fp16=False, local_rank=0)