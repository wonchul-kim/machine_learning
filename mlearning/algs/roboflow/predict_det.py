...
output_dir = '/DeepLearning/_projects/sungjin_body/tests/yolov8_patch/winter/w_json/학습'

# input_dir = '/Data/01.Image/sungjin_yoke/IMAGE/BODY/24.07.29_미검이미지/wo_json/기타'
# json_dir = None
# output_dir = '/DeepLearning/_projects/sungjin_body/tests/yolov8_patch/winter/wo_json/기타'
