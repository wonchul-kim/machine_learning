...
if __name__ == '__main__':
    input_dir = '/DeepLearning/etc/_athena_tests/benchmark/interojo/split_dataset'
    output_dir = '/DeepLearning/etc/_athena_tests/benchmark/interojo/split_dataset_yolo_is'
